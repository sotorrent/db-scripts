...
SELECT Id, PostId, PostHistoryId, PostBlockVersionId, LinkType, LinkPosition, IFNULL(LinkAnchor, ''), Protocol, RootDomain, CompleteDomain, IFNULL(Path, ''), IFNULL(Query, ''), IFNULL(FragmentIdentifier, ''), Url, REPLACE(FullMatch, '\n', '&#xD;&#xA;')
...
SELECT Id, PostId, CommentId, LinkType, LinkPosition, IFNULL(LinkAnchor, ''), Protocol, RootDomain, CompleteDomain, IFNULL(Path, ''), IFNULL(Query, ''), IFNULL(FragmentIdentifier, ''), Url, REPLACE(FullMatch, '\n', '&#xD;&#xA;')
