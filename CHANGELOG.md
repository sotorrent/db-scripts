...
* Add new column `LinkPosition` to tables `PostVersionUrl` and `CommentUrl` (begin, middle, end of post/comment, or "link only" if a comment/post consists only of a URL)
