...
=> gh_so_references_2018_06_17.matched_lines
...
SELECT
  ...
  url,
  line
FROM `sotorrent-org.gh_so_references_2018_06_17.matched_lines` as lines
LEFT JOIN `bigquery-public-data.github_repos.files` as files
ON lines.file_id = files.id;

=> gh_so_references_2018_06_17.matched_files
...
SELECT
  ...
  END as url,
  line
FROM `sotorrent-org.gh_so_references_2018_06_17.matched_files`;

=> gh_so_references_2018_06_17.matched_files_normalized
...
SELECT
  ...
  url,
  line
FROM `sotorrent-org.gh_so_references_2018_06_17.matched_files_normalized`
WHERE
  REGEXP_CONTAINS(url, r'(http:\/\/stackoverflow\.com\/(?:a|q)\/[\d]+)');
  
=> gh_so_references_2018_06_17.matched_files_aq
...
WITH
	copies AS (
		...
		FROM `sotorrent-org.gh_so_references_2018_06_17.matched_files_aq`
		GROUP BY file_id
	)
SELECT
...
FROM `sotorrent-org.gh_so_references_2018_06_17.matched_files_aq` files
JOIN copies
ON files.file_id = copies.file_id;

=> gh_so_references_2018_06_17.PostReferenceGH



###################################################################
# the following tables are not present in gh_so_references_2018_06_17
...
WITH
  answers AS (
    SELECT
	  ...
	  SOUrl,
	  GHUrl
    FROM `sotorrent-org.gh_so_references_2018_06_17.PostReferenceGH` ref
...
=> gh_so_references_2018_06_17.PostReferenceGH_Answers
...
SELECT
  ...
  Score,
  ParentViewCount
FROM `sotorrent-org.gh_so_references_2018_06_17.PostReferenceGH_Answers`;

=> gh_so_references_2018_06_17.PostReferenceGH_Answers_R
...
=> gh_so_references_2018_06_17.PostReferenceGH_Questions
...
SELECT
  ...
  Score,
  ViewCount
FROM `sotorrent-org.gh_so_references_2018_06_17.PostReferenceGH_Questions`;

=> gh_so_references_2018_06_17.PostReferenceGH_Questions_R
